...
// #define TUD_AUDIO_DEVICE_STEREO_DESC_LEN                                  \
    (TUD_AUDIO_DESC_IAD_LEN + TUD_AUDIO_DESC_STD_AC_LEN                    \
     ...
     + TUD_AUDIO_DESC_STD_AS_INT_LEN  /* Interface 1, Alternate 1 */       \
...
// #define TUD_AUDIO_DEVICE_STEREO_DESCRIPTOR(_itfnum, _stridx, _epout, _epin)                                                       \
    ...
    TUD_AUDIO_DESC_IAD(                                                                                                           \
        ...
        TUD_AUDIO_DESC_STD_AS_INT(/*_itfnum*/ (uint8_t)(_itfnum + 2),                                                             \
                                  /*_altset*/ 0x00,                                                                               \
                                  /*_nEPs*/ 0x00, /*_stridx*/                                                                     \
                                  0x04),                                                                                          \
...
#define TUD_AUDIO_SPEAKER_STEREO_FB_DESCRIPTOR(_itfnum, _stridx, _epout, _epin, _epfb, _epfbsize) \
  ...
  TUD_AUDIO_DESC_OUTPUT_TERM(/*_termid*/ UAC2_ENTITY_SPK_OUTPUT_TERMINAL, /*_termtype*/ AUDIO_TERM_TYPE_OUT_DESKTOP_SPEAKER, /*_assocTerm*/ UAC2_ENTITY_SPK_INPUT_TERMINAL, /*_srcid*/ UAC2_ENTITY_SPK_FEATURE_UNIT, /*_clkid*/ UAC2_ENTITY_CLOCK, /*_ctrl*/ 0x0000, /*_stridx*/ 0x00),\
