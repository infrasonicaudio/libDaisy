    ...
    public:
        ...
        EXTIChannel GetChannel(const Pin pin)
        {
            ...
            { 
                ...
                case 4: return EXTI4;
                default:
                    return pin.pin < 10 ? EXTI9_5 : EXTI15_10;
            }
        }
        ...
        IRQn_Type GetIRQNType(const Pin pin)
        {
            ...
            { 
                ...
                default:
                    return pin.pin < 10 ? EXTI9_5_IRQn : EXTI15_10_IRQn;
            }
        }
            ...
            if (__HAL_GPIO_EXTI_GET_IT(stpin) != 0x00U)
              {
                ...
                if (callback != nullptr) callback(pin);
            }
        }
...
void GPIO::Init(const Config &cfg)
{
    ...
    switch(cfg_.mode)
    {
        ...
        case Mode::INTERRUPT_BOTH: ginit.Mode = GPIO_MODE_IT_RISING_FALLING; break;
        case Mode::INPUT:
...
{
    GPIOInterruptHandler::instance().HandleInterrupt(GPIOInterruptHandler::EXTI0);
}

void EXTI1_IRQHandler(void)
{
    GPIOInterruptHandler::instance().HandleInterrupt(GPIOInterruptHandler::EXTI1);
}

void EXTI2_IRQHandler(void)
{
    GPIOInterruptHandler::instance().HandleInterrupt(GPIOInterruptHandler::EXTI2);
}

void EXTI3_IRQHandler(void)
{
    GPIOInterruptHandler::instance().HandleInterrupt(GPIOInterruptHandler::EXTI3);
}

void EXTI4_IRQHandler(void)
{
    GPIOInterruptHandler::instance().HandleInterrupt(GPIOInterruptHandler::EXTI4);
}

void EXTI9_5_IRQHandler(void)
{
    GPIOInterruptHandler::instance().HandleInterrupt(GPIOInterruptHandler::EXTI9_5);
}

void EXTI15_10_IRQHandler(void)
{
    GPIOInterruptHandler::instance().HandleInterrupt(GPIOInterruptHandler::EXTI15_10);
}
